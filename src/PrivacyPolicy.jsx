...
// A simple, honest privacy policy page for Versus Arena.
// Styled to match the site (Cinzel headings, Inter body, cream + gold) using the
// CSS variables already defined in App.css, so it needs no changes to App.css.
//
// It takes a setPage prop so the "Back to Arena" button can return home,
// matching the existing page-switching pattern in App.jsx.
    ...
    <div className="pp-wrap">
      <style>{`
        ...
        @media (max-width: 768px) {
          .pp-wrap { padding: 32px 18px 72px; }
          .pp-title { font-size: 30px; }
        }
      `}</style>

      <div className="pp-inner">
        <button className="pp-back" onClick={() => setPage && setPage("home")}>
          &larr; Back to Arena
        </button>
